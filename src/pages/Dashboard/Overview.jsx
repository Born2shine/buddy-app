    ...
    <>
      <aside className='md:w-[72%]'>
        <div className='stats md:grid md:grid-cols-3 md:gap-4'>
          ...
          <StatCard total={51} label={"Total Channels"} bgColor='green-100'>
        ...
        <div className='graph mt-4 bg-white p-4 rounded-[16px]'>
          <div className='flex justify-between items-center'>
            <h2 className='text-isDark font-semibold md:text-2xl z-10'>
              Overview
            </h2>
            <ul className='flex space-x-2 z-10'>
              <li className='bg-isOrange text-white hover:bg-isOrange hover:text-white cursor-pointer p-[2px] px-[8px] rounded-full text-[8px] md:text-[12px] md:p-2 md:px-6'>
                Robbin Hood
              </li>
              <li className='bg-gray-100 text-gray-400 hover:bg-isOrange hover:text-white cursor-pointer p-[2px] px-[6px] rounded-full text-[8px] md:text-[12px] md:p-2 md:px-6'>
                Amreitrade
              </li>
              <li className='bg-gray-100 text-gray-400 hover:bg-isOrange hover:text-white cursor-pointer p-[2px] px-[6px] rounded-full text-[8px] md:text-[12px] md:p-2 md:px-6'>
                Fidelity
                    ...
                    <nav aria-label='Page navigation example'>
                      <ul className='flex list-style-none'>
                        <li className='page-item disabled'>
                          <a
                            className='page-link text-sm py-1 px-2 relative block border-0 bg-transparent outline-none transition-all duration-300 rounded text-gray-500 pointer-events-none focus:shadow-none'
                            href='#'
                            tabindex='-1'
                            aria-disabled='true'
                          >
                        ...
                        <li className='page-item'>
                          <a
                            className='page-link text-sm py-1 px-2 relative block border-0 bg-transparent outline-none transition-all duration-300 rounded text-gray-800 hover:text-gray-800 hover:bg-gray-200 focus:shadow-none'
                            href='#'
                          >
                            1
                          </a>
                        ...
                        <li className='page-item active'>
                          <a
                            className='page-link text-sm py-1 px-2 relative block border-0 bg-isMaroon outline-none transition-all duration-300 rounded text-white hover:text-white hover:bg-pink-900 shadow-md focus:shadow-md'
                            href='#'
                          >
      ...
      <aside>
        <div className='watchlist bg-white rounded-[16px] p-4 mt-4 md:mt-0'>
          <div className='flex justify-between'>
            ...
            <Link
              to='#'
              className='text-isOrange uppercase font-semibold text-[14px]'
            >
              view all
            </Link>
          </div>
          <div className='flex justify-between bg-[#F6F6F6] rounded-[16px] p-4'>
            <div className='flex flex-col'>
              ...
              <div className='mt-2'>
                <h2 className='font-medium text-[#A3A3A6] leading-5'>
                  $142.90{" "}
                </h2>
